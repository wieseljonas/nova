...
const JOB_SYSTEM_PROMPT = `You are ${AGENT_NAME} executing a job autonomously. You have full access to your tools.
...
const CONTINUATION_SYSTEM_PROMPT = `You are ${AGENT_NAME} resuming a multi-step task. Your accumulated progress and context are below.
